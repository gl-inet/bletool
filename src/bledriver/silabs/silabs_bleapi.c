...
int rx_peek_timeout(int msecond)
{
...
json_object* silabs_get_notify(void)
{
    ...
    {
        json_object_object_add(o,"type",json_object_new_string(UNKNOW_MSG));
        return o;
    }
        ...
        case gecko_evt_system_boot_id:
            {
                ...
                json_object_object_add(o,"major",json_object_new_int(pck.data.evt_system_boot.major));
                json_object_object_add(o,"minor",json_object_new_int(pck.data.evt_system_boot.minor));
                json_object_object_add(o,"patch",json_object_new_int(pck.data.evt_system_boot.patch));
                json_object_object_add(o,"build",json_object_new_int(pck.data.evt_system_boot.build));
                json_object_object_add(o,"bootloader",json_object_new_int(pck.data.evt_system_boot.bootloader));
                json_object_object_add(o,"hw",json_object_new_int(pck.data.evt_system_boot.hw));
                hex2str((uint8*)&pck.data.evt_system_boot.hash,sizeof(uint32),value);
        ...
        case gecko_evt_le_connection_closed_id:
            {
                ...
                json_object_object_add(o,"reason",json_object_new_int(pck.data.evt_le_connection_closed.reason));
                json_object_object_add(o,"connection",json_object_new_int(pck.data.evt_le_connection_closed.connection));
            }
            break;
        case gecko_evt_gatt_characteristic_value_id:
            {
                if(pck.data.evt_gatt_characteristic_value.att_opcode == gatt_handle_value_notification){
                    ...
                    json_object_object_add(o,"connection",json_object_new_int(pck.data.evt_gatt_characteristic_value.connection));
                    json_object_object_add(o,"characteristic",json_object_new_int(pck.data.evt_gatt_characteristic_value.characteristic));
                    json_object_object_add(o,"att_opcode",json_object_new_int(pck.data.evt_gatt_characteristic_value.att_opcode));
                    json_object_object_add(o,"offset",json_object_new_int(pck.data.evt_gatt_characteristic_value.offset));
        ...
        case gecko_evt_gatt_server_attribute_value_id:
            {
                ...
                json_object_object_add(o,"connection",json_object_new_int(pck.data.evt_gatt_server_attribute_value.connection));
                json_object_object_add(o,"attribute",json_object_new_int(pck.data.evt_gatt_server_attribute_value.attribute));
                json_object_object_add(o,"att_opcode",json_object_new_int(pck.data.evt_gatt_server_attribute_value.att_opcode));
                json_object_object_add(o,"offset",json_object_new_int(pck.data.evt_gatt_server_attribute_value.offset));
                hex2str(pck.data.evt_gatt_server_attribute_value.value.data,pck.data.evt_gatt_server_attribute_value.value.len,value);
                json_object_object_add(o,"value",json_object_new_string(value));
            }
            break;
        case gecko_evt_gatt_server_characteristic_status_id:
            {
                ...
                json_object_object_add(o,"connection",json_object_new_int(pck.data.evt_gatt_server_characteristic_status.connection));
                json_object_object_add(o,"characteristic",json_object_new_int(pck.data.evt_gatt_server_characteristic_status.characteristic));
                json_object_object_add(o,"status_flags",json_object_new_int(pck.data.evt_gatt_server_characteristic_status.status_flags));
                json_object_object_add(o,"client_config_flags",json_object_new_int(pck.data.evt_gatt_server_characteristic_status.client_config_flags));
            }
            break;
        case gecko_evt_le_gap_scan_response_id:
            {
                json_object_object_add(o,"type",json_object_new_string(ADV_PKG));
                json_object_object_add(o,"rssi",json_object_new_int(pck.data.evt_le_gap_scan_response.rssi));
                json_object_object_add(o,"packet_type",json_object_new_int(pck.data.evt_le_gap_scan_response.packet_type));
                addr2str(&pck.data.evt_le_gap_scan_response.address,addr);
                json_object_object_add(o,"address",json_object_new_string(addr));
                json_object_object_add(o,"address_type",json_object_new_int(pck.data.evt_le_gap_scan_response.address_type));
                json_object_object_add(o,"bonding",json_object_new_int(pck.data.evt_le_gap_scan_response.bonding));
                hex2str(pck.data.evt_le_gap_scan_response.data.data, pck.data.evt_le_gap_scan_response.data.len,value);
...
json_object* silabs_ble_local_mac(void)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_system_get_bt_address_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    ...
    char addr[18];
    addr2str(&pck.data.rsp_system_get_bt_address.address,addr);
...
json_object* silabs_ble_discovery(int phys,int interval,int window,int type,int mode)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_gap_set_discovery_timing_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_gap_set_discovery_timing.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_le_gap_set_discovery_timing.result));
        return obj;       
    }
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_gap_set_discovery_type_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_gap_set_discovery_type.result)
    {
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_gap_start_discovery_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_gap_start_discovery.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_le_gap_start_discovery.result));
        return obj;       
    }
...
json_object* silabs_ble_adv(int adv_phys,int adv_interval_min,int adv_interval_max,int adv_discover,int adv_conn)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_gap_set_advertise_phy_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_gap_set_advertise_phy.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_le_gap_set_advertise_phy.result));
        return obj;       
    }
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_gap_set_advertise_timing_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_gap_set_advertise_timing.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_le_gap_set_advertise_timing.result));
        return obj;       
    }
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_gap_start_advertising_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_gap_start_advertising.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_le_gap_start_advertising.result));
        return obj;       
    }
...
json_object* silabs_ble_adv_data(int adv_data_flag,char* adv_data)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_gap_bt5_set_adv_data_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_gap_bt5_set_adv_data.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_le_gap_bt5_set_adv_data.result));
        return obj;       
    }
...
json_object* silabs_ble_send_notify(int send_noti_conn,int send_noti_char,char* send_noti_value)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_gatt_server_send_characteristic_notification_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_gatt_server_send_characteristic_notification.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_gatt_server_send_characteristic_notification.result));
        return obj;       
    }


    json_object_object_add(obj,"sent_len",json_object_new_int(pck.data.rsp_gatt_server_send_characteristic_notification.sent_len));
    json_object_object_add(obj,"code",json_object_new_int(SUCCESS));
    return obj;
}
...
json_object* silabs_ble_connect(char* address,int address_type,int conn_phy)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_gap_connect_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_gap_connect.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_le_gap_connect.result));
        return obj;       
    }
    int connection = pck.data.rsp_le_gap_connect.connection;
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_evt_le_connection_opened_id) 
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    json_object_object_add(obj,"code",json_object_new_int(SUCCESS));
    json_object_object_add(obj,"connection",json_object_new_int(pck.data.evt_le_connection_opened.connection));
    char str[18] = {0};
    addr2str(&pck.data.evt_le_connection_opened.address,str);
    json_object_object_add(obj,"address",json_object_new_string(str));
    json_object_object_add(obj,"address_type",json_object_new_int(pck.data.evt_le_connection_opened.address_type));
    json_object_object_add(obj,"master",json_object_new_int(pck.data.evt_le_connection_opened.master));
    json_object_object_add(obj,"bonding",json_object_new_int(pck.data.evt_le_connection_opened.bonding));
    json_object_object_add(obj,"advertiser",json_object_new_int(pck.data.evt_le_connection_opened.advertiser));
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_evt_le_connection_parameters_id ||
        pck.data.evt_le_connection_parameters.connection != connection) 
    {
        return obj;       
    }
    json_object_object_add(obj,"interval",json_object_new_int(pck.data.evt_le_connection_parameters.interval));
    json_object_object_add(obj,"latency",json_object_new_int(pck.data.evt_le_connection_parameters.latency));
    json_object_object_add(obj,"timeout",json_object_new_int(pck.data.evt_le_connection_parameters.timeout));
    json_object_object_add(obj,"security_mode",json_object_new_int(pck.data.evt_le_connection_parameters.security_mode));
    json_object_object_add(obj,"txsize",json_object_new_int(pck.data.evt_le_connection_parameters.txsize));
...
json_object* silabs_ble_disconnect(int connection)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_connection_close_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_connection_close.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_le_connection_close.result));
        return obj;       
    }
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_evt_le_connection_closed_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    json_object_object_add(obj,"code",json_object_new_int(SUCCESS));
    json_object_object_add(obj,"connection",json_object_new_int(pck.data.evt_le_connection_closed.connection));
    json_object_object_add(obj,"reason",json_object_new_int(pck.data.evt_le_connection_closed.reason));
...
json_object* silabs_ble_get_rssi(int connection)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_le_connection_get_rssi_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_le_connection_get_rssi.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_le_connection_get_rssi.result));
        return obj;       
    }
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_evt_le_connection_rssi_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    ...
    json_object_object_add(obj,"code",json_object_new_int(SUCCESS));
    json_object_object_add(obj,"connection",json_object_new_int(pck.data.evt_le_connection_rssi.connection));
    json_object_object_add(obj,"status",json_object_new_int(pck.data.evt_le_connection_rssi.status));
    json_object_object_add(obj,"rssi",json_object_new_int(pck.data.evt_le_connection_rssi.rssi));
...
json_object* silabs_ble_get_service(int connection)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_gatt_discover_primary_services_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_gatt_discover_primary_services.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_gatt_discover_primary_services.result));
        return obj;       
    }
    ...
    while(1)
    {
        ...
        if(BGLIB_MSG_ID(pck.header) == gecko_evt_gatt_service_id && pck.data.evt_gatt_service.connection == connection)
        {
            o = json_object_new_object();
            l = json_object_object_get(obj,"service_list");
            json_object_object_add(o,"service_handle",json_object_new_int(pck.data.evt_gatt_service.service));
            memset(value,0,256);
            reverse_endian(pck.data.evt_gatt_service.uuid.data,pck.data.evt_gatt_service.uuid.len);
            hex2str(pck.data.evt_gatt_service.uuid.data,pck.data.evt_gatt_service.uuid.len,value);
            json_object_object_add(o,"service_uuid",json_object_new_string(value));
            json_object_array_add(l,o);
        }
        if(BGLIB_MSG_ID(pck.header) == gecko_evt_gatt_procedure_completed_id)
        {
            return obj;
        }
    }
...
json_object* silabs_ble_get_char(int connection,int service_handle)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_gatt_discover_characteristics_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_gatt_discover_characteristics.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_gatt_discover_characteristics.result));
        return obj;       
    }
    ...
    while(1)
    {
        ...
        if(BGLIB_MSG_ID(pck.header) == gecko_evt_gatt_characteristic_id && pck.data.evt_gatt_characteristic.connection == connection)
        {
            o = json_object_new_object();
            l = json_object_object_get(obj,"characteristic_list");
            json_object_object_add(o,"characteristic_handle",json_object_new_int(pck.data.evt_gatt_characteristic.characteristic));
            memset(value,0,256);
            reverse_endian(pck.data.evt_gatt_characteristic.uuid.data,pck.data.evt_gatt_characteristic.uuid.len);
            hex2str(pck.data.evt_gatt_characteristic.uuid.data,pck.data.evt_gatt_characteristic.uuid.len,value);
            json_object_object_add(o,"characteristic_uuid",json_object_new_string(value));
            json_object_object_add(o,"properties",json_object_new_int(pck.data.evt_gatt_characteristic.properties));
            json_object_array_add(l,o);
        }
        if(BGLIB_MSG_ID(pck.header) == gecko_evt_gatt_procedure_completed_id)
        {
...
json_object* silabs_ble_set_power(int power)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_system_set_tx_power_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    json_object_object_add(obj,"code",json_object_new_int(SUCCESS));
    json_object_object_add(obj,"power",json_object_new_int(pck.data.rsp_system_set_tx_power.set_power));
...
json_object* silabs_ble_read_char(int connection,int char_handle)
{
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_gatt_read_characteristic_value_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_gatt_read_characteristic_value.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_gatt_read_characteristic_value.result));
        return obj;       
    }
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_evt_gatt_characteristic_value_id || pck.data.evt_gatt_characteristic_value.connection != connection)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
...
json_object* silabs_ble_write_char(int connection,int char_handle,char* value,int write_res)
{
    ...
    if(write_res)
    {
        ...
        if(BGLIB_MSG_ID(pck.header) != gecko_rsp_gatt_write_characteristic_value_id)
        {
            json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
            return obj;       
        }
        if(pck.data.rsp_gatt_write_characteristic_value.result)
        {
            json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_gatt_write_characteristic_value.result));
            return obj;       
        }
        ...
        if(BGLIB_MSG_ID(pck.header) != gecko_evt_gatt_procedure_completed_id || pck.data.evt_gatt_procedure_completed.connection != connection)
        {
            json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
            return obj;       
        }
        if(pck.data.evt_gatt_procedure_completed.result)
        {
            json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_gatt_write_characteristic_value.result));
            return obj;       
        }
        ...
        if(BGLIB_MSG_ID(pck.header) != gecko_rsp_gatt_write_characteristic_value_without_response_id)
        {
            json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
            return obj;       
        }
        if(pck.data.rsp_gatt_write_characteristic_value_without_response.result)
        {
            json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_gatt_write_characteristic_value_without_response.result));
            return obj;       
        }
        json_object_object_add(obj,"code",json_object_new_int(SUCCESS));
        json_object_object_add(obj,"sent_len",json_object_new_int(pck.data.rsp_gatt_write_characteristic_value_without_response.sent_len));
    }
    return obj;
}
...
{        
    ...
    if(BGLIB_MSG_ID(pck.header) != gecko_rsp_gatt_set_characteristic_notification_id)
    {
        json_object_object_add(obj,"code",json_object_new_int(RESPONSE_MISSING));
        return obj;       
    }
    if(pck.data.rsp_gatt_set_characteristic_notification.result)
    {
        json_object_object_add(obj,"code",json_object_new_int(pck.data.rsp_gatt_set_characteristic_notification.result));
        return obj;       
    }
